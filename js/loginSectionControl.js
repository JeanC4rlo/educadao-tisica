const SECAO_LOGIN = document.getElementById("login-section");
const SECAO_CADASTRO = document.getElementById("cadastro-section");
    ...
    `
        <div class="login-surface">
            ...
            <div class="login-inputs-surface">
                <input class="login-input" id="usuario-input" type="email" placeholder="Email">
                <input class="login-input" id="senha-input" type="password" placeholder="Senha">
            </div>
    ...
    <div class="cadastro-surface">
        ...
        <form onsubmit="cadastrar(event)">
            <div class="input-text-surface">
                <input id="nome-input" class="input-padrao" type="text" placeholder="Nome" required>
                <input id="sobrenome-input" class="input-padrao" type="text" placeholder="Sobrenome">
            </div>
            ...
            <div class="input-text-surface">
                <input id="email-input" class="input-padrao" type="email" placeholder="seuemail@email.com" required>
                <input id="senha-input" class="input-padrao" type="password" placeholder="Crie uma Senha" required>
            </div>
